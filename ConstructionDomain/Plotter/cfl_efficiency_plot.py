...
def generate_efficiency_plots(generations, sruns, n_dig_sites, coupling, sample_rate=20):
    # Plot Color Palette
    ...
    if not os.path.exists('Plots'):  # If Data directory does not exist, create it
        os.makedirs('Plots')
    plt.savefig(f"Plots/CFL_{n_dig_sites}DS_C{coupling}_Efficiency.pdf")
...
if __name__ == "__main__":
    ...
    generate_efficiency_plots(generations, sruns, n_dig_sites, coupling)
